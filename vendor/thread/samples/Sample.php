...
#var_dump(scandir(__DIR__ . '/../Threading/Task'));

include(__DIR__ . '/../Threading/Multiple.php');
include(__DIR__ . '/../Threading/Task/Base.php');
include(__DIR__ . '/../Threading/Task/Example.php');
