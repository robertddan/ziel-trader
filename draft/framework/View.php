...
namespace App\Suiteziel\Framework;
...
*/
		...
		elseif (!isset($this->aUri[2])) exit('View -> uri');
		elseif ($this->aUri[3] == 'assets') {
			$sAssetFile = '/workspace/action/draft/src/Suiteziel/Ziel/Draft/Template/';#. $this->aUri[3] .'/'. $this->aUri[4] .'/'. $this->aUri[5] .'/'. $this->aUri[6];
